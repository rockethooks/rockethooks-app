    ...
    <div className="max-w-4xl mx-auto p-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          A comprehensive component library for building modern, accessible, and
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        >
          ...
          <p className="text-sm text-gray-600 mb-4">
            Foundation elements including colors, typography, spacing, and
            design tokens
          </p>
      ...
      >
        ...
        <div className="space-y-3 text-sm">
          <div className="flex items-start space-x-3">
            ...
            <p>
              Browse components in the sidebar to explore available UI elements
            </p>
          </div>
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-semibold">
          ...
          <div className="flex items-start space-x-3">
            ...
            <p>
              Check the Docs tab for detailed prop documentation and usage
              examples
            </p>
          </div>
          <div className="flex items-start space-x-3">
